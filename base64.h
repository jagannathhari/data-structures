...
int main() {
    ...
    assert(strcmp("", (char *)base64_decode("YgtwKz9lRjFaSmgpS2UtDCp4PmhCYwszSTFzNzpXV0BfaWQ7SDN1YGk8bFNTNAk9VFVUQiYvKFRbPWA/bTxpW2Zm",88,&decoded_data,&length)) == 0);
    free(encoded_data);
    free(decoded_data);
    ...
    assert(strcmp("\x2d\x70\x56\x48\x52\x4f\x2b\x57\x76\x60\x4c\x73\x7b\x72\x24\x6a\x43\x5f\x60\x6f\x2b\x5f\x68\x47\x43\x47\x0b\x4c\x65\x4c\x46\x42\x6b\x60\x4f\x2f\x67\x28\x2d", (char *)base64_decode("LXBWSFJPK1d2YExze3IkakNfYG8rX2hHQ0cLTGVMRkJrYE8vZygt",52,&decoded_data,&length)) == 0);
    free(encoded_data);
    free(decoded_data);

    assert(strcmp("CnIMSUcj", base64_encode((unsigned char*)"\x0a\x72\x0c\x49\x47\x23", 6, &encoded_data)) == 0);
    assert(strcmp("\x0a\x72\x0c\x49\x47\x23", (char *)base64_decode("CnIMSUcj",8,&decoded_data,&length)) == 0);
    free(encoded_data);
    free(decoded_data);
    ...
    assert(strcmp("\x77\x52\x21\x55\x3f\x53\x63\x49\x4f\x68\x31\x25\x65\x5f\x39\x73\x38\x31\x56\x71\x6e\x5f\x50\x49\x3b\x4e\x27\x32\x6d\x3c\x78", (char *)base64_decode("d1IhVT9TY0lPaDElZV85czgxVnFuX1BJO04nMm08eA==",44,&decoded_data,&length)) == 0);
    free(encoded_data);
    free(decoded_data);
    ...
    assert(strcmp("\x65\x77\x25\x5e\x4f\x7d\x74\x41\x52\x3b\x61\x47\x25\x4c\x7c\x72\x37\x76\x4b\x38\x75\x25\x60\x25\x78\x29\x09\x09\x5e\x62\x45\x62\x2a\x78\x6c\x5f\x25\x75\x63\x76\x54", (char *)base64_decode("ZXclXk99dEFSO2FHJUx8cjd2Szh1JWAleCkJCV5iRWIqeGxfJXVjdlQ=",56,&decoded_data,&length)) == 0);
    free(encoded_data);
    free(decoded_data);
    ...
    assert(strcmp("", (char *)base64_decode("QW9bZi4zKmZkI09PLFUvTy5lZmZUZHR2MSsxTncjYVMMIlVaeWNoTEJ+ZWpOeGpqTnluUS5nTUJIc09JJj1VYSBUCkxtKkAgejlKRGB7",104,&decoded_data,&length)) == 0);
    free(encoded_data);
    free(decoded_data);
    ...
    assert(strcmp("\x79\x79\x2a\x6a\x5f\x23\x27\x42\x51\x72\x55\x52\x52\x42\x58\x62\x29\x68\x51\x45\x57\x45\x79\x3c\x36\x37\x4d\x65\x32\x5c\x2b\x72\x60\x21\x76", (char *)base64_decode("eXkqal8jJ0JRclVSUkJYYiloUUVXRXk8NjdNZTJcK3JgIXY=",48,&decoded_data,&length)) == 0);
    free(encoded_data);
    free(decoded_data);
    return 0;
}
